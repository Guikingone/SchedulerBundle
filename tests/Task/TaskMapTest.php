...
final class TaskMapTest extends TestCase
{
    ...
    {
        $taskList = new TaskMap();
        $taskList->add(new NullTask('foo'), new NullTask('bar'));
    ...
    {
        $taskList = new TaskMap();
        $taskList->offsetSet(null, new NullTask('foo'));
    ...
    {
        $taskList = new TaskMap();
        $taskList->offsetSet('foo', new NullTask('foo'));
    ...
    {
        $taskList = new TaskMap([new NullTask('foo')]);
    ...
    {
        $taskList = new TaskMap([new NullTask('foo'), new NullTask('bar')]);
