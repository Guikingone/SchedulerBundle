...
final class NullTaskTest extends TestCase
{
     ...
     */
    public function testTaskExpressionCanBeRelative(string $expression, string $endExpression): void
    {
        $task = new NullTask('foo', [
            'expression' => $expression,
        ]);

        self::assertNotSame('* * * * *', $task->getExpression());
        self::assertSame($endExpression, $task->getExpression());
    }
