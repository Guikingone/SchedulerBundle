...
final class DoctrineTransportFactoryTest extends TestCase
{
    public function testTransportCanSupport(): void
    {
        ...
        self::assertFalse($doctrineTransportFactory->support('test://', new InMemoryConfiguration()));
        self::assertTrue($doctrineTransportFactory->support('doctrine://', new InMemoryConfiguration()));
        self::assertTrue($doctrineTransportFactory->support('dbal://', new InMemoryConfiguration()));
    }
    ...
    public function testFactoryReturnTransportWithExecutionMode(): void
    {
        ...
        self::assertInstanceOf(DoctrineTransport::class, $doctrineTransportFactory->createTransport(Dsn::fromString('doctrine://default?execution_mode=first_in_first_out'), new InMemoryConfiguration(), $serializer, $schedulePolicyOrchestrator));
    }
