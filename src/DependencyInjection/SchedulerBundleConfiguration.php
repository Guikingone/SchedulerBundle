            ...
            ->getRootNode()
                ...
                ->children()
                    ...
                    ->arrayNode('configuration')
                        ...
                        ->children()
                            ->enumNode('mode')
                                ->info('Define the configuration mode (default, lazy or fiber)')
                                ->values(['default', 'lazy', 'fiber'])
                                ->defaultValue('default')
                            ->end()
                            ->scalarNode('dsn')
                            ...
                            ->arrayNode('schedulers')
                                ->useAttributeAsKey('name')
                                    ->arrayPrototype()
                                        ->children()
                                            ->scalarNode('endpoint')
                                            ->info('Define the endpoint used by the scheduler to communicate with the pool')
                                            ->defaultValue(null)
                                        ->end()
                                    ->end()
                                ->end()
                    ...
                    ->arrayNode('worker')
                        ...
                        ->children()
                            ...
                            ->end()
                            ->scalarNode('registry')
                                ->info('Enable the worker registry')
                                ->defaultValue(false)
                            ->end()
                        ->end()
                    ->end()
                    ->arrayNode('middleware')
                        ...
                        ->children()
                            ->enumNode('mode')
                                ->info('The current middleware mode (default or fiber)')
                                ->values(['default', 'fiber'])
                                ->defaultValue('default')
                            ->end()
                        ->end()
